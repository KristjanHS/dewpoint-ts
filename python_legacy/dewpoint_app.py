...
# Add timestamp to force fresh geolocation on refresh
if "geolocation_timestamp" not in st.session_state:
    st.session_state["geolocation_timestamp"] = datetime.now().timestamp()

# Force fresh geolocation by including timestamp
timestamp = st.session_state.get("geolocation_timestamp", datetime.now().timestamp())
